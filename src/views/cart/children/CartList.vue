<template>
  <div class="cart-list">
    <scroll class="scroll-height" ref="carScroll">
      <!-- 循环部分 -->
      <div :key="item.iid" class="shop-item" v-for="item in cartList">
        <div class="item-selector">
          <van-checkbox @change="handleCheckedItem" v-model="item.checked" checked-color= "var(--color-tint)"/>
        </div>
        <div class="item-img">
        ...
        <div class="item-info">
          ...
          <div class="info-bottom">
            ...
            <div class="item-count right">
              <button @click="reduceCount(item.iid)">-</button>
              x{{ item.count }}
              <button @click="addCount(item.iid)">+</button>
              </div>
          </div>
        </div>
      </div>
    ...
    <div class="cart-bottom-bar">
      <div class="cart-bottom-check">
        <van-checkbox @click="handleCheckedAll" class="checked-all" v-model="checkedAll" checked-color= "var(--color-tint)">
          全选
        </van-checkbox>
      </div>
...
export default {
  ...
  methods: {
    ...
    reduceCount(iid){
        this.$store.commit('reduceCount',iid)
    },
    addCount(iid){
